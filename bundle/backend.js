...
var sound_info_model_1 = __webpack_require__(11);
var statistics_model_1 = __webpack_require__(12);
var metrics_model_1 = __webpack_require__(13);
...
function storeManager() {
    return {
        ...
        // },
        setMetrics: function (soundId, metric) {
        ...
        createNewMetrics: function (metrics) {
            return __awaiter(this, void 0, void 0, function () {
                var mResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        getSoundStats: function (soundId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        setSoundStats: function (soundId, stat) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, STATS
        ...
        registerNewSound: function (formData, userID) {
            return __awaiter(this, void 0, void 0, function () {
                var registered;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, SOUND_META.create(__assign({}, formData, { user_id: userID }))];
                        case 1:
                            registered = _a.sent();
                            if (registered) {
                                return [2 /*return*/, { ok: true, payload: registered }];
                            }
                            else {
        ...
        updateSoundByProp: function (id, prop) {
            return __awaiter(this, void 0, void 0, function () {
                var soundDoc;
                return __generator(this, function (_a) {
                    switch (_a.label) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var backend_1 = __webpack_require__(7);
function boot() {
...
Object.defineProperty(exports, "__esModule", { value: true });
var db_config_1 = __webpack_require__(8);
var https = __webpack_require__(10);
var fs = __webpack_require__(1);
var store_manager_1 = __webpack_require__(2);
var public_events_1 = __webpack_require__(14);
var private_events_1 = __webpack_require__(18);
...
function dbStart() {
    ...
    mongoose.Promise = __webpack_require__(9);
...
Object.defineProperty(exports, "__esModule", { value: true });
var store_manager_1 = __webpack_require__(2);
var login_manager_1 = __webpack_require__(4);
...
function publicEvents(socket) {
    ...
    socket.on('GET_SOUNDS_META', function (sessionId, callback) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeM.getAllSoundsMeta()];
                case 1:
                    info = _a.sent();
...
var login_manager_1 = __webpack_require__(4);
var store_manager_1 = __webpack_require__(2);
var transcoding_service_1 = __webpack_require__(19);
var loginM = new login_manager_1.LoginManager();
var storeM = store_manager_1.storeManager();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!jwtResponse.ok) return [3 /*break*/, 3];
                    return [4 /*yield*/, transcoding_service_1.uploadSound(jwtResponse.payload.uid, payload.sound_id, payload.data)
                    ...
                    if (jwtResponse.ok) {
                        ...
                        if (response) {
                            callback({
                                ok: true,
                                payload: {
                                    response: __assign({}, response, { sound_id: payload.id }),
                                }
                            });
                        }
                        else {
...
Object.defineProperty(exports, "__esModule", { value: true });
var fs_manager_1 = __webpack_require__(20);
var ffmpeg_service_1 = __webpack_require__(21);
var store_manager_1 = __webpack_require__(2);
var fs = __webpack_require__(1);
...
Object.defineProperty(exports, "__esModule", { value: true });
var fs = __webpack_require__(1);
var spawn = __webpack_require__(22).spawn;
